...
def _coerce_int(value: Any, default: int) -> int:
    """Parse integer configuration values for gateway server startup."""
    try:
        return int(value)
    except Exception:
        return default
...
def _resolve_logger(cfg: Any) -> logging.Logger:
    """Create the gateway service logger from config and environment settings."""
...
def _bind_addr(cfg: Any) -> str:
    """Return the gateway gRPC server bind address as "host:port"."""
